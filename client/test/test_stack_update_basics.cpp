  ...
  for (D_UINT i = 0; i < _valuesCount; ++i)
    {
      ...
      if ((WGetStackTextLengthCount (hnd, WIGNORE_FIELD, WIGNORE_ROW, WIGNORE_OFF, &elemesCount) != WCS_INVALID_ARGS)
          ...
          || (WGetStackValueEntry (hnd, "some_field", WIGNORE_ROW, WIGNORE_OFF, WIGNORE_OFF, &value) != WCS_INVALID_ARGS)
          || (WGetStackValueEntry (hnd, WIGNORE_FIELD, 0, WIGNORE_OFF, WIGNORE_OFF, &value) != WCS_INVALID_ARGS)
          || (WGetStackValueEntry (hnd, WIGNORE_FIELD, WIGNORE_ROW, 0, WIGNORE_OFF, &value) != WCS_INVALID_ARGS)
          || (WGetStackValueEntry (hnd, WIGNORE_FIELD, WIGNORE_ROW, WIGNORE_OFF, 0, &value) != WCS_INVALID_ARGS)
