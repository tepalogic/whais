...
static const unsigned int WCS_PROTOCOL_NOTSUPP   = 5;
static const unsigned int WCS_ENCTYPE_NOTSUPP    = 6;
static const unsigned int WCS_UNEXPECTED_FRAME   = 7;
static const unsigned int WCS_INVALID_FRAME      = 8;
static const unsigned int WCS_COMM_OUT_OF_SYNC   = 9;
static const unsigned int WCS_LARGE_ARGS         = 10;
static const unsigned int WCS_LARGE_RESPONSE     = 11;
static const unsigned int WCS_CONNECTION_TIMEOUT = 12;
static const unsigned int WCS_SERVER_BUSY        = 13;
static const unsigned int WCS_INCOMPLETE_CMD     = 14;
static const unsigned int WCS_INVALID_ARRAY_OFF  = 15;
static const unsigned int WCS_INVALID_TEXT_OFF   = 16;
static const unsigned int WCS_INVALID_ROW        = 17;
static const unsigned int WCS_INVALID_FIELD      = 18;
static const unsigned int WCS_TYPE_MISMATCH      = 19;
