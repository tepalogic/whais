...
static const struct MsgCodeEntry messages[] = {
  ...
  {MSG_TABLE_INCOMPLETE, MSG_ERROR_EVENT,
   "Identifier \'%s\' declared as a generic table. This is possible only for function parameters declarations."},
  {MSG_ARRAY_INCOMPLETE, MSG_ERROR_EVENT,
   "Identifier \'%s\' declared as a generic array. This is possible only for function parameters declarations."},
  {MSG_FIELD_INCOMPLETE, MSG_ERROR_EVENT,
   "Identifier \'%s\' declared as a generic field. This is possible only for function parameters declarations."},
  ...
  {MSG_SADD_NA, MSG_ERROR_EVENT,
   "Can not use operator '+=' with a variable of type '%s' and an operand of type '%s'."},
