...
char test_prog_3[] = ""
  ...
  "ENDPROC\n "
  "\n "
  "PROCEDURE Proc_1 (v2 DATE) RETURN BOOL\n "
  "DO\n " "RETURN TRUE;\n " "ENDPROC\n ";

char test_prog_4[] = ""
  "PROCEDURE Proc_1 (v1 DATE) RETURN BOOL\n "
  "DO\n "
  "VAR v_t BOOL;\n "
  "RETURN v_t;\n "
  "ENDPROC\n "
...
char test_prog_5[] = ""
  ...
  "ENDPROC\n "
  "\n "
  "EXTERN PROCEDURE Proc_1 (v1 DATE) RETURN BOOL;\n ";
  ...
  char test_prog_7[] = ""
    "EXTERN PROCEDURE Proc_2 (a INT16) RETURN INT32;\n "
    "PROCEDURE Proc_1 (v1 DATE) RETURN BOOL\n "
    "DO\n "
    "VAR v_t BOOL;\n "
    "RETURN v_t;\n "
  ...
  char test_prog_8[] = ""
    ...
    "ENDPROC\n "
    "\n "
    "PROCEDURE Proc_2(a INT16) RETURN INT32\n "
    "DO\n "
    "VAR v1 INT32;\n "
    "RETURN v1;\n "
    "ENDPROC\n "
  ...
  char test_prog_9[] = ""
    "EXTERN PROCEDURE Proc_2 (b TEXT, c DATE) RETURN INT32;\n "
    "PROCEDURE Proc_1 (v1 DATE) RETURN BOOL\n "
    "DO\n "
    "VAR v_t BOOL;\n "
    "RETURN v_t;\n "
    "ENDPROC\n "
    "\n "
    "PROCEDURE Proc_2(b TEXT, c DATETIME) RETURN INT32\n "
    "DO\n "
    "VAR v1 INT32;\n "
    "RETURN v1;\n "
    "ENDPROC\n "
