...
D_CHAR test_prog_1[] = ""
  ...
  "DO\n "
  "LET table_1 AS TABLE WITH (field AS UNSIGNED INT64, field2 AS DATE);\n "
  "LET one_row AS ROW OF TABLE table_1;\n "
  "LET fake as ROW OF TABLE one_row;\n " "RETURN v1;\n " "ENDPROC\n ";
D_CHAR test_prog_2[] = ""
  "PROCEDURE Proc_2 ( v1 AS BOOL ) RETURN BOOL\n "
  "DO\n " "LET fake AS ROW OF TABLE v1;\n " "RETURN v1;\n " "ENDPROC\n ";
...
main ()
{
  ...
  test_result = test_for_error (test_prog_1, MSG_NOT_TABLE, MSG_ERROR_EVENT);
  test_result =
