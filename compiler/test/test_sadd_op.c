...
char proc_decl_buffer[] =
  ...
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId4 (v1 AS REAL, v2 AS UINT8) RETURN REAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId5 (v1 AS RICHREAL, v2 AS UINT8) RETURN RICHREAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  ...
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId10 (v1 AS TEXT, v2 AS CHAR) RETURN TEXT "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
