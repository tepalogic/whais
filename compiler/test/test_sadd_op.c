...
D_CHAR proc_decl_buffer[] =
  ...
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId4 (v1 AS REAL, v2 AS UNSIGNED INT8) RETURN REAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId5 (v1 AS RICHREAL, v2 AS UNSIGNED INT8) RETURN RICHREAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId6 (v1 AS REAL, v2 AS REAL) RETURN REAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId7 (v1 AS REAL, v2 AS RICHREAL) RETURN REAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId8 (v1 AS RICHREAL, v2 AS REAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId9 (v1 AS RICHREAL, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId10 (v1 AS TEXT, v2 AS CHARACTER) RETURN TEXT "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "PROCEDURE ProcId11 (v1 AS TEXT, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 += v2; "
  "ENDPROC\n\n"
  "";
