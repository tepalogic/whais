...
char proc_decl_buffer[] =
  ...
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId22 (v1 AS TEXT, v2 AS BOOL) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId23 (v1 AS TEXT, v2 AS CHAR) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId24 (v1 AS TEXT, v2 AS DATE) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId25 (v1 AS TEXT, v2 AS DATETIME) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId26 (v1 AS TEXT, v2 AS HIRESTIME) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId27 (v1 AS TEXT, v2 AS INT8) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId28 (v1 AS TEXT, v2 AS INT16) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId29 (v1 AS TEXT, v2 AS INT32) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId30 (v1 AS TEXT, v2 AS INT64) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId31 (v1 AS TEXT, v2 AS REAL) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId32 (v1 AS TEXT, v2 AS RICHREAL) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId33 (v1 AS TEXT, v2 AS UINT8) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId34 (v1 AS TEXT, v2 AS UINT16) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId35 (v1 AS TEXT, v2 AS UINT32) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId36 (v1 AS TEXT, v2 AS UINT64) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId37 (v1 AS TEXT, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n";
