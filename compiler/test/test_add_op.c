...
D_CHAR proc_decl_buffer[] =
  ...
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId7 (v1 AS INT8, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  ...
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId9 (v1 AS INT16, v2 AS INT32) RETURN INT32 "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId10 (v1 AS INT16, v2 AS INT64) RETURN INT64 "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId11 (v1 AS INT16, v2 AS REAL) RETURN REAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId12 (v1 AS INT16, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId13 (v1 AS INT16, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId14 (v1 AS INT32, v2 AS INT32) RETURN INT32 "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId15 (v1 AS INT32, v2 AS INT64) RETURN INT64 "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId16 (v1 AS INT32, v2 AS REAL) RETURN REAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId17 (v1 AS INT32, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId18 (v1 AS INT32, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId19 (v1 AS INT64, v2 AS INT64) RETURN INT64 "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId20 (v1 AS INT64, v2 AS REAL) RETURN REAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId21 (v1 AS INT64, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId22 (v1 AS INT64, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId23 (v1 AS REAL, v2 AS REAL) RETURN REAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId24 (v1 AS REAL, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId25 (v1 AS REAL, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId26 (v1 AS RICHREAL, v2 AS RICHREAL) RETURN RICHREAL "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId27 (v1 AS RICHREAL, v2 AS TEXT) RETURN TEXT "
  "DO "
  "RETURN v1 + v2; "
  "ENDPROC\n\n"
  ""
  "PROCEDURE ProcId28 (v1 AS RICHREAL, v2 AS TEXT) RETURN TEXT "
