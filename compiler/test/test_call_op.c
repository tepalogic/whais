...
char proc_decl_buffer[] =
  ...
  "RETURN BOOL "
  "DO "
  "VAR v1 AS ARRAY OF DATE; "
  "VAR v2 AS ARRAY OF TEXT; "
  ...
  "RETURN BOOL "
  "DO "
  "VAR v1 AS TABLE OF (v1 AS DATE, v2 AS INT8, v3 as ARRAY OF INT8); "
  "VAR v2 AS TABLE OF (v1 AS HIRESTIME, v2 AS TEXT, v3 AS ARRAY OF BOOL); "
