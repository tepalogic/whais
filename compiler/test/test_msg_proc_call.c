...
char test_prog_1[] = ""
  "VAR table_2 AS TABLE OF ( f1 as DATE); \n"
  " \n"
...
char test_prog_2[] = ""
  "VAR table_1 AS TABLE OF ( f1 as DATE, f2 as INT16); \n"
  " \n"
  ...
  "PROCEDURE Proc_1_2 () RETURN DATE \n"
  "DO \n"
  "VAR proc_arg  AS INT16; \n"
  "VAR some_arg AS TEXT; \n"
...
char test_prog_5[] = ""
  ...
  "PROCEDURE Proc_1_2 () RETURN DATE \n"
  "DO \n"
  "VAR some_var as FIELD OF ARRAY OF DATE;"
  "Proc_1 ( some_var, 10 ); \n" "RETURN some_var; \n" "ENDPROC \n";
...
char test_prog_12[] = ""
  ...
  "DO \n"
  "VAR some_var as DATE;"
  "VAR tv as FIELD OF ARRAY OF INT8;"
  "Proc_1 ( tv, 10 ); \n"
  "RETURN some_var;\n"
  "ENDPROC \n";
...
char test_prog_33[] = ""
  ...
  "DO \n"
  "VAR some_var as DATE;"
  "VAR tv as FIELD OF ARRAY OF DATE;"
  "Proc_1 ( tv, 10 ); \n"
  "RETURN some_var;\n"
  "ENDPROC \n";
