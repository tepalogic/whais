...
DO
	...
	LET local8 AS INT64;
	LET local9 AS UINT8;
	LET local10 AS UINT16;
	LET local11 AS UINT32;
	LET local12 AS UINT64;
	LET local13 AS REAL;
	LET local14 AS RICHREAL;
	LET local15 AS TEXT;

	LET local16 AS ARRAY OF BOOL;
	LET local17 AS ARRAY OF UINT;
	...
	LET local25 AS ARRAY OF UINT8;
	LET local26 AS ARRAY OF UINT16;
	LET local27 AS ARRAY OF UINT32;
	LET local28 AS ARRAY OF UINT64;
	LET local29 AS ARRAY OF REAL;
	LET local30 AS ARRAY OF RICHREAL;

	LET local31 AS FIELD OF BOOL;
	LET local32 AS FIELD OF UINT;
	...
	LET local40 AS FIELD OF UINT8;
	LET local41 AS FIELD OF UINT16;
	LET local42 AS FIELD OF UINT32;
	LET local43 AS FIELD OF UINT64;
	...
	LET local48 AS FIELD OF ARRAY OF UINT;
	...
	LET local56 AS FIELD OF ARRAY OF UINT8;
	LET local57 AS FIELD OF ARRAY OF UINT16;
	LET local58 AS FIELD OF ARRAY OF UINT32;
	LET local59 AS FIELD OF ARRAY OF UINT64;
