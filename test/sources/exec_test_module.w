...
PROCEDURE same_char (a AS CHARACTER) RETURN CHARACTER
DO 
	RETURN a;
ENDPROC
...
PROCEDURE same_uint8 (a AS UNSIGNED INT8) RETURN UNSIGNED INT8
DO 
	RETURN a;
ENDPROC

PROCEDURE same_uint16 (a AS UNSIGNED INT16) RETURN UNSIGNED INT16
DO 
	RETURN a;
ENDPROC

PROCEDURE same_uint32 (a AS UNSIGNED INT32) RETURN UNSIGNED INT32
DO 
	RETURN a;
ENDPROC

PROCEDURE same_uint64 (a AS UNSIGNED INT64) RETURN UNSIGNED INT64
DO 
	RETURN a;
ENDPROC
