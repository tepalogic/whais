...
get_test_array ()
{
  ...
  array.AddElement (DBSInt16 (0xFF));
  array.AddElement (DBSInt16 (0));
  array.AddElement (DBSInt16 (-7812));
  array.AddElement (DBSInt16 (0x1012));
...
main ()
{
...

  {
    ...
    Int16Operand op (DBSInt16 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DBSInt16 (3));
