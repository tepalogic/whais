...
get_test_array ()
{
  ...
  array.AddElement (DBSInt64 (0xFF));
  array.AddElement (DBSInt64 (0));
  array.AddElement (DBSInt64 (-1234123498123434));
  array.AddElement (DBSInt64 (0x1012));
  array.AddElement (DBSInt64 (0x10122334));
  array.AddElement (DBSInt64 (0x10122334FDABCDAA));
...
main ()
{
...

  {
    ...
    Int64Operand op (DBSInt64 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DBSInt64 (3));
