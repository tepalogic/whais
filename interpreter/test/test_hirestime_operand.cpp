...
get_test_array()
{
  ...
  array.Add (DHiresTime( 2002, 2, 14, 0, 0, 0, 1));
  array.Add (DHiresTime( 2012, 12, 25, 23, 59, 59, 0));
  array.Add (DHiresTime( -12, 10, 10, 18, 0, 1, 999999));
  array.Add (DHiresTime( -1024, 2, 2, 8, 1, 0, 12));
