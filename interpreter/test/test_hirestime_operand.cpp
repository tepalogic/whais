...
get_test_array ()
{
  ...
  array.AddElement (DBSHiresTime (2002, 2, 14, 0, 0, 0, 1));
  array.AddElement (DBSHiresTime (2012, 12, 25, 23, 59, 59, 0));
  array.AddElement (DBSHiresTime (-12, 10, 10, 18, 0, 1, 999999));
  array.AddElement (DBSHiresTime (-1024, 2, 2, 8, 1, 0, 12));
...
main ()
{
...

  {
    ...
    HiresTimeOperand op (DBSHiresTime (0, 1, 1, 0, 0, 0, 0));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op,
                                          DBSHiresTime (0,1,1, 0, 59, 0, 0));
    success = success && test_array_read_value (
                                            get_test_array (),
                                            DBSHiresTime (0,1,1, 0, 59, 0, 0)
                                                );
