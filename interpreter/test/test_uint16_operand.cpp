...
get_test_array ()
{
  ...
  array.AddElement (DBSUInt16 (0xFF));
  array.AddElement (DBSUInt16 (0));
  array.AddElement (DBSUInt16 (1));
  array.AddElement (DBSUInt16 (0x1012));
...
main ()
{
...

  {
    ...
    UInt16Operand op (DBSUInt16 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DBSUInt16 (3));
