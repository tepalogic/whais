...
get_test_array ()
{
  ...
  array.Add (DUInt64 (0xFF));
  array.Add (DUInt64 (0));
  array.Add (DUInt64 (1));
  array.Add (DUInt64 (0x1012));
  array.Add (DUInt64 (0x10122334));
  array.Add (DUInt64 (0x10122334FDABCDAA));
...
main ()
{
...

  {
    ...
    UInt64Operand op (DUInt64 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DUInt64 (3));
