...
get_test_array()
{
  ...
  array.Add (DDateTime (2002, 2, 14, 0, 0, 0));
  array.Add (DDateTime (2012, 12, 25, 23, 59, 59));
  array.Add (DDateTime (-12, 10, 10, 18, 0, 1));
  array.Add (DDateTime (-1024, 2, 2, 8, 1, 0));
...
main()
{
...

  {
    ...
    DateTimeOperand op (DDateTime (0, 1, 1, 0, 0, 0));
