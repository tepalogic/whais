...
get_test_array ()
{
  ...
  array.AddElement (DBSInt8 (0xFf));
  array.AddElement (DBSInt8 (0));
  array.AddElement (DBSInt8 (-100));
  array.AddElement (DBSInt8 (10));
...
main ()
{
...

  {
    ...
    Int8Operand op (DBSInt8 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DBSInt8 (3));
