...
get_test_array ()
{
  ...
  array.AddElement (DBSInt32 (0xFF));
  array.AddElement (DBSInt32 (0));
  array.AddElement (DBSInt32 (-10234145));
  array.AddElement (DBSInt32 (0x1012));
  array.AddElement (DBSInt32 (0x10122334));
...
main ()
{
...

  {
    ...
    Int32Operand op (DBSInt32 (10));
    success = success && test_op_invalid_conv (op);
    success = success && test_null_write (op, DBSInt32 (3));
