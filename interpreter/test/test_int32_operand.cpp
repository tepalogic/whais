...
get_test_array()
{
  ...
  array.Add (DInt32 (0xFF));
  array.Add (DInt32 (0));
  array.Add (DInt32 (-10234145));
  array.Add (DInt32 (0x1012));
  array.Add (DInt32 (0x10122334));
...
main()
{
...

  {
    ...
    Int32Operand op (DInt32 (10));
    success = success && test_op_invalid_conv( op);
    success = success && test_null_write( op, DInt32 (3));
