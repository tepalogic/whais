...
CC_FLAGS+=$(EXT_CC_FLAGS) --std=c++14

DEFINES+=ARCH_LINUX_GCC
DEFINES+=INLINE=inline__
DEFINES+=ARCH_PPC64
DEFINES+=GNU_SOURCE
...
arch_linker_flags:=$(EXT_LD_FLAGS) -static-libstdc++ -m64 -pthread -ldl -Wl,-Bsymbolic,-Bsymbolic-functions,-z,defs -fvisibility=hidden
ifeq ($(PROFILE),yes)
arch_linker_flags+= -pg
endif

arch_shl_linker_flags=-static-libstdc++ -fvisibility=hidden -m64 -pthread -ldl -shared -Wl,-z,defs,-Bsymbolic,-Bsymbolic-functions,--exclude-libs,ALL,-soname,lib$(1).so$(2)
