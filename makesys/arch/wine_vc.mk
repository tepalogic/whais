...
ARCH_LIB_PREFIX:=
ARCH_LIB_EXT:=.lib
CC:=wine '/home/ipopa/.wine/drive_c/Program Files/Microsoft Visual Studio 9.0/VC/bin/cl.exe'
CXX:=wine '/home/ipopa/.wine/drive_c/Program Files/Microsoft Visual Studio 9.0/VC/bin/cl.exe'
LD:=wine '/home/ipopa/.wine/drive_c/Program Files/Microsoft Visual Studio 9.0/VC/bin/cl.exe'
AR:=wine '/home/ipopa/.wine/drive_c/Program Files/Microsoft Visual Studio 9.0/VC/bin/lib.exe'

#Debuging does not work for Windows with wine!
ifeq ($(FLAVOR),debug)
CC_FLAGS?=/W3 /TC /c  /Y- /arch:SSE2 /GF /Z7 /RTC1 /RTCc /nologo
CXX_FLAGS?=$(subst /TC,/TP,$(CC_FLAGS)) /EHsc
endif

ifeq ($(FLAVOR),release)
DEFINES+=-DNDEBUG
CC_FLAGS?=/W3 /TC /c  /Y- /arch:SSE2 /GF /O2 /nologo
CXX_FLAGS?=$(subst /TC,/TP,$(CC_FLAGS)) /EHsc
endif
