                        ...
                        DBSArray &tableValues)
{
  ...
  for (D_UINT index = 0; index < rowCount; ++index)
    {
      DBSUInt16 value (false, w_rnd () & 0xFFFF);
  ...
  DBSArray values = table.GetMatchingRows (DBSUInt16 (true),
                                           DBSUInt16 (false, 0xFFFF),
                                           0,
                                           ~0,
                                           0,
                                           ~0,
...
main ()
{
  ...
  {
    DBSArray tableValues (_SC (DBSUInt16*, NULL));
    {
