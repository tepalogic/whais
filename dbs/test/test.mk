...
test_wfilecontainer_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_wfilecontainer_INC=utils/include custom/include

UNIT_EXES+=test_dbsmgr
test_dbsmgr_SRC=test/test_dbsmgr.cpp
test_dbsmgr_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_dbsmgr_INC=utils/include custom/include

UNIT_EXES+=test_createtable
test_createtable_SRC=test/test_createtable.cpp
test_createtable_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_createtable_INC=utils/include custom/include

#Not used anymore
#UNIT_EXES+=test_catree
#test_catree_SRC=test/test_catree.cpp
#test_catree_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
#test_catree_INC=utils/include custom/include

UNIT_EXES+=test_dbstext
test_dbstext_SRC=test/test_dbstext.cpp
test_dbstext_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_dbstext_INC=utils/include custom/include

UNIT_EXES+=test_varstore
test_varstore_SRC=test/test_varstore.cpp
test_varstore_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_varstore_INC=utils/include custom/include

UNIT_EXES+=test_dbsarray
test_dbsarray_SRC=test/test_dbsarray.cpp
test_dbsarray_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_dbsarray_INC=utils/include custom/include

UNIT_EXES+=test_tabledata
test_tabledata_SRC=test/test_tabledata.cpp
test_tabledata_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
test_tabledata_INC=utils/include custom/include

UNIT_EXES+=l_test_arraysort
l_test_arraysort_SRC=test/test_arraysort.cpp
l_test_arraysort_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_tablermrows_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_uint8btindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_uint16btindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_uint64btindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_charbtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_datebtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_datetimebtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_hirestimebtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_realbtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
...
l_test_richrealbtindex_LIB=dbs/slpastra utils/utils custom/custom custom/slcommon
