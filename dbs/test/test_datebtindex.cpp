...
static DBSDate _max_date (false, 0x7FFF, 12, 31);
                        ...
                        DBSArray &tableValues)
{
  ...
  DBSArray values = table.GetMatchingRows (DBSDate (true),
                                           _max_date,
                                           0,
                                           ~0,
                                           0,
